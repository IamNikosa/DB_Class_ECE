...
BEGIN
    ...
    IF v_Visitor_ID IS NOT NULL THEN
        ...
        IF v_Ticket_ID IS NOT NULL THEN
            ...
            VALUES (UUID_SHORT(), TRUE, v_Ticket_ID, v_Visitor_ID);
...
BEGIN
    ...
    SELECT BQ.ID, VW.Visitor_ID INTO v_Buy_Queue_ID, v_Visitor_ID
    FROM Buy_Queue BQ
    ...
    IF v_Visitor_ID IS NOT NULL THEN
        ...
        -- Block insert into Tickets_In_Resale
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'Ticket directly assigned to waitlisted visitor — resale record skipped.';
    END IF;
