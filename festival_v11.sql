...
BEGIN
    ...
    IF v_Is_Sold_Out THEN
        ...
        -- (same as before) activate resale queue & waitlist
    ...
    ELSE
        ...
        IF v_New_Ticket_ID IS NULL THEN
            SIGNAL SQLSTATE '45000'
              SET MESSAGE_TEXT = 'No available ticket found for this event/type.';
        END IF;
        ...
        -- record the purchase (this will also update Ticket.Date_Bought & Payment_ID via your trigger)
